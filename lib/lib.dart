...
class _LibState extends State<Lib> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      // Show Disclaimer
      if (!Provider.of<ConfigurationProvider>(context, listen: false)
          .disclaimerAccepted) {
        await showDialog(
            ...
            showDialog(
                ...
                builder: (context) => AppUpdateDialog(
                      ...
                      Provider.of<ConfigurationProvider>(context)
                          .videoDownloadPath,
                      Provider.of<ConfigurationProvider>(context).packageName,
                    ));
          }
        });
      });
                      ...
                      child: AnimatedSwitcher(
                          ...
                          child: NotificationListener<ScrollNotification>(
                              onNotification: (ScrollNotification details) {
                                if (details.metrics.pixels - position >=
                                        sensitivityFactor &&
                                ...
                                } else if (position - details.metrics.pixels >=
                                        sensitivityFactor &&
                                    details.metrics.axis == Axis.vertical) {
                                  position = details.metrics.pixels;
                                  navigationBarAnimationController.forward();
